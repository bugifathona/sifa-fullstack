  ...
  <div class="flex-shrink max-w-full px-4 w-full mb-6">
    <div class="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full text-gray-700">
      <div class="relative">
        ...
        <form x-data="{ disabled: false }" x-on:submit="disabled = true" action="{{ route('sysadmin.credential.roles.update', $role->id) }}" method="POST">
          @csrf
          @method('PUT')
          ...
          <div class="px-6 py-3 border-t dark:border-gray-700 flex justify-end">
            ...
            <x-form-submit label="Update Role"></x-form-submit>
          </div>
        </form>
      </div>
    </div>
