    ...
    <div class="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full text-gray-700">
      <div class="relative p-4 overflow-x-auto">
        ...
        <table class="table-auto w-full">
          <tr>
            <td class="p-2 w-3/12">Class Grade Name</td>
            <td class="p-2 w-1/12">:</td>
            <td class="p-2 w-8/12">{{ $class_grade->name }}</td>
          </tr>
          <tr>
            <td class="p-2 w-3/12">Class Alias</td>
            <td class="p-2 w-1/12">:</td>
            <td class="p-2 w-8/12">{{ $class_grade->alias }}</td>
          </tr>
          <tr>
            <td class="p-2 w-3/12">Education Level</td>
            <td class="p-2 w-1/12">:</td>
            <td class="p-2 w-8/12">{{ $class_grade->refEducationLevel->name }}</td>
          </tr>
          <tr>
            <td class="p-2 w-3/12">Other Info</td>
            <td class="p-2 w-1/12">:</td>
            <td class="p-2 w-8/12">{{ $class_grade->other_info == '' ? '-' : $class_grade->other_info }}</td>
          </tr>
        </table>
        <div class="px-6 py-3 border-t dark:border-gray-700 flex justify-end">
          ...
          <a href="{{ route('sysadmin.reference.class-grades.edit', $class_grade->id) }}" class="py-2 px-4 inline-block text-center rounded leading-5 text-gray-100 bg-green-500 border border-green-500 hover:text-white hover:bg-green-700 hover:ring-0 hover:border-green-700 focus:bg-green-600 focus:border-green-700 focus:outline-none focus:ring-0 mx-2">
            Edit
          </a>
        </div>
      </div>
